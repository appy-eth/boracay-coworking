...
export default function HeroCn() {
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <span className="text-cyan-400 font-medium tracking-wide">长滩岛，菲律宾</span>
        </div>
        ...
        <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
          距离海滩仅几步之遥的长滩岛高级联合办公空间。高速Starlink互联网、泳池使用权，
          以及在天堂高效工作所需的一切。
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20">
            ...
            <span className="text-white font-medium">Starlink 互联网</span>
          </div>
          <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20">
            <Coffee className="w-5 h-5 text-cyan-400" />
            <span className="text-white font-medium">咖啡吧</span>
          </div>
          <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20">
            <Waves className="w-5 h-5 text-cyan-400" />
            <span className="text-white font-medium">泳池使用</span>
          </div>
        </div>
